...
describe('Cross chain test input Fee', async function () {
  ...
  it("SWAP Test", async function () {
    ...
    await crosschainstablecoinpool.setBuyBackTreasury(true);


    console.log(" +++++++++ Total Fee : " + await crosschainstablecoinpool.calculateTotalFee());
